// This class searches for any command handlers with the message start as their name, or an alias and executes the handler if found.
...
module.exports = 
{
    handle(client, message, cooldowns) 
	{
        ...
        if(!message.content.startsWith(client.botConfig.prefix) || message.author.bot) 
		{
			return;
		}
